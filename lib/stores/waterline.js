...
function waterlineStoreFactory(waterline, Logger, assert, Promise, _) {
    ...
    WaterlineStore.prototype.get = function(queryValue, queryKey) {
        ...
        var query = {};
        query[queryKey] = queryValue;
        return Promise.resolve(this.model.findOne(query))
        .then(function(doc) {
    ...
    WaterlineStore.prototype.getAll = function(filter) {
        return Promise.resolve(this.model.find(filter || {}))
        .then(function(docs) {
    ...
    WaterlineStore.prototype.remove = function(queryValue, queryKey) {
        ...
        var query = {};
        query[queryKey] = queryValue;
        return Promise.resolve(this.model.destroy(query));
    };
