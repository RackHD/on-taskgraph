 ...
 */
function factory(MemoryStore, WaterlineStore, assert, Promise, _) {
    function Registry() {
    }
    ...
    Registry.prototype.fetchGraphDefinitionCatalog = function(filter){
        return this.graphDefinitionStore.getAll(filter);
    };

    Registry.prototype.fetchGraphHistory = function(filter) {
        return this.graphHistoryStore.getAll(filter);
    };

    Registry.prototype.persistGraphObject = function(instanceId, value) {
        return this.graphHistoryStore.put(instanceId, value);
    };
    ...
    Registry.prototype.putActiveGraphSync = function(graph, target) {
        ...
        if (target && this.hasActiveGraphSync(target)) {
    ...
    Registry.prototype.start = function() {
        ...
        this.graphHistoryStore = new WaterlineStore('graphobjects', 'instanceId');
