...
TaskGraphStore.prototype.getAll = function() {
...
function SubscriberFactory(tgrProtocol, assert, Q, _, TaskGraph) {
    ...
    Subscriber.prototype.stop = function stop() {
        var self = this;
        return Q.all(_.map(runningInstanceStore.getAll(), function(taskGraph) {
    ...
    Subscriber.prototype.runTaskGraph = function runTaskGraph(uniqueName, options) {
        ...
        var taskGraph = new TaskGraph.create(taskGraphDefinition, options);
