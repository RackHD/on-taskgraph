...
module.exports = {
    ...
    tasks: [
        ...
        //=======================
        {
            label: 'ipmi-power-alert',
            taskDefinition: {
                friendlyName: 'IPMI Power status alerter',
                injectableName: 'Task.Inline.Poller.Alert.Ipmi.Power',
                implementsTask: 'Task.Base.Poller.Alert.Ipmi.Power',
                options: {},
                properties: {}
            }
        },
