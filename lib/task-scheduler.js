...
function taskSchedulerFactory(
        ...
        .then(function(data) {
            ...
            var progressData = {
                ...
                taskProgress: {
                    ...
                    progress: {
                        value: self.maxTaskProgress,
                        maximum: self.maxTaskProgress,
            ...
            return taskMessenger.publishProgressEvent(data.graphId, progressData);
        })
     ...
     * @memberOf TaskScheduler
     */
    TaskScheduler.prototype.publishGraphFinishedProgressEvent = function(graph) {
        return Promise.try(function() {
            assert.object(graph, 'graph');
            assert.object(graph.definition, 'graph.definition');
            assert.string(graph.definition.friendlyName,
