...
function factory(Task, scheduler, registry, eventsProtocol, schedulerProtocol,
    ...
    function TaskGraph(definition) {
        ...
        this.tasks = {};
        this.ready = [];
        this.finishedOutcomes = ['failed', 'succeeded', 'timeout', 'canceled'];
        ...
        Object.defineProperty(this, 'finishedTasks', {
            get: function() {
                var self = this;
                return _.compact(_.map(this.tasks, function(task) {
                    return _.contains(self.finishedOutcomes, task.outcome) ? task : undefined;
                }));
            }
        });
    ...
    TaskGraph.prototype.cancel = function() {
        logger.error("TASKGRAPH CANCEL NOT IMPLEMENTED");
    };

    TaskGraph.prototype.start = function () {
        var self = this;
        self.validate();
        self._populateTaskDependencies();
    ...
    TaskGraph.prototype.stop = function() {
        this.cancel();
